...
function treemenu(name, showLines, showIcons, useCookies) {                     //>treemenu
 ...
 this.defaults = {                                                              // Default images/icons
   iconRoot  : 'Images/treemenu/root.gif',        iconItem  : 'Images/treemenu/item.gif',               //    ..        ..
   iconOpen  : 'Images/treemenu/open.gif',        iconClose : 'Images/treemenu/close.gif',              //    ..        ..
   passLine  : 'Images/treemenu/passline.gif',    empty     : 'Images/treemenu/empty.gif',              //    ..        ..
   tieLine   : 'Images/treemenu/tieline.gif',     tiePlus   : 'Images/treemenu/tieplus.gif',            //    ..        ..
   endLine   : 'Images/treemenu/endline.gif',     endPlus   : 'Images/treemenu/endplus.gif',            //    ..        ..
   rectPlus  : 'Images/treemenu/rectplus.gif',    tieMinus  : 'Images/treemenu/tieminus.gif',           //    ..        ..
   rectMinus : 'Images/treemenu/rectminus.gif',   endMinus  : 'Images/treemenu/endminus.gif',           //    ..        ..
   minIcon   : 'Images/treemenu/minicon.gif'  } }                                           //
                                                                                // ----------- Build up menu -----------
...
treemenu.prototype.writeIndenting = function(node) {                            //>WriteIndenting
 ...
 for (var i=0; i<=node.indent-2; i++) {                                         // Loop from left to right:
      ...
      str += '<img border=0 name="' + icons[i] + '" src="' + icon + '" alt="" />'; }     //   Html-string for the icon
 return str;  }                                                                 // Return html-string
...
treemenu.prototype.writeTieUpIcon = function(node)  {                           //>WriteTieUpIcon
 ...
 if (0==node.childs.length)                                                     // No childs -> Return only TieUpIcon
      str = '<img border=0 id="' + this.name + 'TieUp_' + node.id                        //   Write tieUpIcon with
          + '" src="' + icon + '" alt="" />';                                   //   name & source
 else str = '<a href="javascript: ' + this.name + '.toggle(' + node.id + ')">'  // Parent node:
          +  '<img border=0 id="' + this.name + 'TieUp_' + node.id                       //   Write tieUpIcon with
...
treemenu.prototype.writeNodeSymbol = function(node) {                           //>WriteNodeSymbol
 ...
 if (0==node.childs.length) {                                                   // No childs:
   ...
   str += '<img border=0 id="' + this.name + 'Symbol_' + node.id                         //   Write the Html-code for the
 ...
 return   '<a href="javascript: ' + this.name + '.toggle(' + node.id + ')">'    // Parent:
          + '<img border=0  id="' + this.name + 'Symbol_' + node.id                       //   Write Html-string for the image
